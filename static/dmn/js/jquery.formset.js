...
;(function($) {
    $.fn.formset = function(opts)
    {
        var options = $.extend({}, $.fn.formset.defaults, opts),
            ...
            insertDeleteLink = function(row) {
                if (row.is('TR')) {
                    ...
                    row.append('<li><a class="btn ' + options.deleteCssClass + '" href="javascript:void(0)">' + options.deleteText +'</a></li>');
                } else {
                    // Otherwise, just insert the remove button as the
                    // last child element of the form's container:
                    row.append('<a class="btn ' + options.deleteCssClass + '" href="javascript:void(0)">' + options.deleteText +'</a>');
                }
        ...
        if ($$.length) {
            ...
            if (options.formTemplate) {
                ...
                template.find('input,select,textarea,label,.repl').each(function() {
            ...
            if ($$.attr('tagName') == 'TR') {
                ...
                $$.filter(':last').after('<a style="margin-top:-40px;" class="btn ' + options.addCssClass + '" href="javascript:void(0)">' + options.addText + '</a>');
            ...
            addButton.click(function() {
                ...
                row.find('input,select,textarea,label,.repl').each(function() {
    ...
    $.fn.formset.defaults = {
        ...
        addText: 'добавить вложение',          // Text for the add link
        deleteText: 'убрать эту форму',            // Text for the delete link
